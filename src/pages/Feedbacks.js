...
import { useNavigate } from "react-router-dom";
  ...
  //  const loadTable = () => {};
   ...
   const handleShow = () => {
    axios
      .get(`http://localhost:4000/feedbacks/filter/${Date}`)
      .then((response) => {
     ...
     <div className="filters-container d-flex justify-content-center pt-4 pb-4">
      ...
      {feedbacksearch.length===0 ? (
       ...
       <div>
        ...
        <div className="col-md-2">
          <Button onClick={handleShow}>Filter Forums by date</Button>
        </div>
      </div>
       )}
       {feedbacksearch.map((feedback, index) => (
          ...
          {/* Modal to show the filtered data and window.print to print filtered data 📅*/}
       <Modal show={show} fullscreen={true} onHide={handleClose} size="xl">.
        <Modal.Header closeButton>
          <Modal.Title>Forums on Due Date</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <div className="row">
            <div className="col">
